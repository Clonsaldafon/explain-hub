...
$app->singleton('view', function ($app) {
    ...
    $bladeCompiler = new Illuminate\View\Compilers\BladeCompiler($filesystem, $config['compiled']);
    $resolver->register('blade', function () use ($bladeCompiler) {
        return new Illuminate\View\Engines\CompilerEngine($bladeCompiler);
    });
    $finder = new Illuminate\View\FileViewFinder($filesystem, $config['paths']);
    return new Illuminate\View\Factory($resolver, $finder, $app['events']);
});
